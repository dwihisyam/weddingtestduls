...
<body>
    ...
    <div class="w3-top w3-hide-small">
        <div class="w3-bar w3-white w3-center w3-padding w3-opacity-min w3-hover-opacity-off">
            <a href="<?= base_url('template/template1') ?>" style="width:50%" class="w3-bar-item w3-button">Template 1</a>
            <a href="<?= base_url('template/template2') ?>" style="width:50%" class="w3-bar-item w3-button">Template 2</a>
        </div>
    </div>
