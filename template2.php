...
<body>
    ...
    <!-- Header / Home-->
    <header class="w3-display-container w3-wide bgimg" id="home2">
    ...
    <!-- About / Jane And John -->
    <div class="w3-container w3-padding-64 w3-center page" id="us2" style="background-color:#EEEEEE">
        <div class="w3-content">
            <h1 class="mb-5"><b>About</b></h1>
            <div class="row">
                <div class="col-md-6" data-aos="fade-right" data-aos-easing="ease-in-sine">
                    <img class="img-fluid mb-3" src="img/story-1.jpg" alt="" style="border-radius:50%">
                ...
                <div class="col-md-6" data-aos="fade-left" data-aos-easing="ease-in-sine">
                    <img class="img-fluid mb-3" src="img/story-2.jpg" alt="" style="border-radius:50%">
    ...
    <!-- Party -->
    <div class="w3-container w3-padding-64 w3-center page" id="party2">
        <div class="w3-content">
            ...
            <div>
                ...
                <div class="row mt-5" style="text-align:end">
                    ...
                    <div class="col-md-5">
                        <img class="img-fluid mb-3" src="img/progress-2.png" alt="">
                    </div>
    ...
    <!-- Quotes -->
    <header class="w3-display-container w3-wide bgimg2" id="quotes2">
    ...
    <!-- Gallery -->
    <div class="w3-container w3-padding-64 w3-center page" id="gallery2" style="background-color:#EEEEEE">
        <div class="w3-content">
            <h1 class="mb-5"><b>Gallery</b></h1>
            <div class="row my-5">
                <div data-aos="zoom-in" class="col-md-3">
                    <img width="90%" class="mx-auto my-3" src="img/Image-01.jpg" alt="">
                </div>
                <div data-aos="zoom-in" class="col-md-3">
                    <img width="90%" class="mx-auto my-3" src="img/Image-02.jpg" alt="">
                </div>
                <div data-aos="zoom-in" class="col-md-3">
                    <img width="90%" class="mx-auto my-3" src="img/Image-03.jpg" alt="">
                </div>
                <div data-aos="zoom-in" class="col-md-3">
                    <img width="90%" class="mx-auto my-3" src="img/Image-04.jpg" alt="">
                </div>
                <div data-aos="zoom-in" class="col-md-3">
                    <img width="90%" class="mx-auto my-3" src="img/Image-04.jpg" alt="">
                </div>
    ...
    <!-- Location -->
    <div class="w3-container w3-padding-64 w3-center page" id="location2">
        <div class="w3-content">
    ...
    <div class="w3-bottom w3-hide-small">
        <div class="w3-bar w3-white w3-center w3-padding w3-opacity-min w3-hover-opacity-off">
            <a href="#home2" style="width:16.6%" class="w3-bar-item w3-button">Home</a>
            <a href="#us2" style="width:16.6%" class="w3-bar-item w3-button">About</a>
            <a href="#party2" style="width:16.6%" class="w3-bar-item w3-button">Ceremony</a>
            <a href="#quotes2" style="width:16.6%" class="w3-bar-item w3-button">Quotes</a>
            <a href="#gallery2" style="width:16.6%" class="w3-bar-item w3-button">Gallery</a>
            <a href="#location2" style="width:16.6%" class="w3-bar-item w3-button">Location</a>
        </div>
    </div>
